...
public class GlobalRankController {
    ...
    public String globalUserRank(Model model,
        ...
        searchFacade.insertSearchResult(SearchCommand.builder().menu("globalUser")
    ...
    public String globalOrgRank(Model model,
        ...
        String login = sessionCheck(model);
        searchFacade.insertSearchResult(SearchCommand.builder().menu("globalOrg")
                .page(page).size(size).languageBy(languageBy).sortBy(sortBy).ip(request.getRemoteAddr()).login(login).build());
    ...
    public String globalSourceRank(Model model,
        ...
        String login = sessionCheck(model);
        searchFacade.insertSearchResult(SearchCommand.builder().menu("globalSource")
                .page(page).size(size).languageBy(languageBy).sortBy(sortBy).ip(request.getRemoteAddr()).login(login).build());
